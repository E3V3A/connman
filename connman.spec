...
Patch3:     connman-start-session.patch
Patch4:     0004-Allow-radio-user-to-send-to-connman.patch
Requires:   dbus >= 1.4
...
%patch2 -p1
# connman-start-session.patch
%patch3 -p1
# 0004-Allow-radio-user-to-send-to-connman.patch
%patch4 -p1
# >> setup
# << setup
